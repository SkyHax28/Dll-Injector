...
// Helper function: Get process ID
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_COMMAND:
        if ((HWND)lParam == hSelectDllButton) {
            ...
            MessageBoxW(hwnd, selectedDllPath.c_str(), L"Selected DLL", MB_OK);
        }
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE, LPSTR, int nCmdShow) {
    ...
    // Create UI elements
    CreateWindowW(L"STATIC", L"Process name (e.g. Minecraft.Windows.exe):", WS_VISIBLE | WS_CHILD,
    ...
    hSelectDllButton = CreateWindowW(L"BUTTON", L"Select DLL", WS_VISIBLE | WS_CHILD,
